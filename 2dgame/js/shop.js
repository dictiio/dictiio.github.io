...
const shopItems = {
	skins: {
		default: {
			...
			price: 0,
			description:
				"The default dragon, simple and boring, with the essence of water and air combined.",
		},
		adultgreendragon: {
			...
			price: 100,
			description:
				"A green dragon in its prime, with sharp intellect and unmatched power, fully matured and formidable.",
		},
		babybrassdragon: {
			...
			price: 200,
			description:
				"A small, adorable brass dragon, still learning the ways of the world with a playful spirit.",
		},
		babycopperdragon: {
			...
			price: 500,
			description:
				"A small copper dragon, curious and energetic, beginning to explore its powers and surroundings.",
		},
		mudwyvern: {
			name: "Mud Wyvern",
			...
			price: 1000,
			description:
				"A wyvern composed of mud and earth, with the power to manipulate the terrain around it.",
		},
		poisondrake: {
			name: "Poison Drake",
			...
			price: 2500,
			description:
				"A dragon made of toxic poison, with venomous breath that can corrupt anything it touches.",
		},
		viridiandrake: {
			name: "Viridian Drake",
			...
			price: 5000,
			description:
				"A majestic green dragon, connected to nature and known for its elegant flight and silent strength.",
		},
		youngbrassdragon: {
			...
			price: 10000,
			description:
				"A young brass dragon, full of energy and a keen sense of humor, with the beginnings of its great potential.",
		},
	},
};
